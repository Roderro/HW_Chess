public class ChessBoard {
    ...
    public boolean moveToPosition(int startLine, int startColumn, int endLine, int endColumn) {
        if (board[startLine][startColumn] == null) return false;//проверка, что поле которым идут не пустое
    ...
    public boolean castling0() {
        if (nowPlayer.equals("White")) {
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that King and Rook
                    ...
                    && board[7][0].check && board[7][4].check // check that King and Rook don't move
    ...
    public boolean castling7() {
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][7].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that King and Rook
                    board[0][5] == null && board[0][6] == null && board[0][7].check && board[0][4].check
            ...
            if (board[7][7].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that King and Rook
                    board[7][5] == null && board[7][6] == null && board[7][0].check && board[7][4].check
